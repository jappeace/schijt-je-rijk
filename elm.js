...
var _jappeace$schijt_je_rijk$Support$message = function (x) {
	return A2(
		_elm_lang$core$Task$perform,
		_elm_lang$core$Basics$identity,
		_elm_lang$core$Task$succeed(x));
};
var _jappeace$schijt_je_rijk$Support$join = A2(
	_elm_lang$core$List$foldr,
	F2(
		function (x, y) {
	...
	{ctor: '[]'});
var _jappeace$schijt_je_rijk$Support$flatMap = F2(
	function (f, list) {
		return _jappeace$schijt_je_rijk$Support$join(
			A2(_elm_lang$core$List$map, f, list));
	});
var _jappeace$schijt_je_rijk$Support$flatMap2 = F3(
	function (f, list1, list2) {
		return _jappeace$schijt_je_rijk$Support$join(
			A3(_elm_lang$core$List$map2, f, list1, list2));
	});

var _jappeace$schijt_je_rijk$Vector$angle = function (vec) {
	return A2(_elm_lang$core$Basics$atan2, vec.y, vec.x);
};
var _jappeace$schijt_je_rijk$Vector$lengthSq = function (vector) {
	return (vector.x * vector.x) + (vector.y * vector.y);
};
var _jappeace$schijt_je_rijk$Vector$length = function (vector) {
	return _elm_lang$core$Basics$sqrt(
		_jappeace$schijt_je_rijk$Vector$lengthSq(vector));
};
var _jappeace$schijt_je_rijk$Vector$modularf = F2(
	function (val, bound) {
		return (_elm_lang$core$Native_Utils.cmp(val, 0) < 0) ? (val + bound) : ((_elm_lang$core$Native_Utils.cmp(val, bound) > 0) ? (val - bound) : val);
	});
var _jappeace$schijt_je_rijk$Vector$Vector = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _jappeace$schijt_je_rijk$Vector$apply = F3(
	function (f, vec, oth) {
		return A2(
			_jappeace$schijt_je_rijk$Vector$Vector,
			A2(f, vec.x, oth.x),
			A2(f, vec.y, oth.y));
	});
var _jappeace$schijt_je_rijk$Vector$multiply = F2(
	function (a, b) {
		return A3(
			_jappeace$schijt_je_rijk$Vector$apply,
			F2(
				function (x, y) {
					return x * y;
				}),
...
var _jappeace$schijt_je_rijk$Vector$divide = F2(
	function (a, b) {
		return A3(
			_jappeace$schijt_je_rijk$Vector$apply,
			F2(
...
var _jappeace$schijt_je_rijk$Vector$plus = F2(
	function (a, b) {
		return A3(
			_jappeace$schijt_je_rijk$Vector$apply,
			F2(
...
var _jappeace$schijt_je_rijk$Vector$minus = F2(
	function (a, b) {
		return A3(
			_jappeace$schijt_je_rijk$Vector$apply,
			F2(
...
var _jappeace$schijt_je_rijk$Vector$modular = F2(
	function (bounds, input) {
		return A3(_jappeace$schijt_je_rijk$Vector$apply, _jappeace$schijt_je_rijk$Vector$modularf, input, bounds);
	});
var _jappeace$schijt_je_rijk$Vector$applySingle = F2(
	function (f, vec) {
		return A2(
			_jappeace$schijt_je_rijk$Vector$Vector,
			f(vec.x),
...
var _jappeace$schijt_je_rijk$Vector$normalize = function (vector) {
	var len = _jappeace$schijt_je_rijk$Vector$length(vector);
	return A2(_jappeace$schijt_je_rijk$Vector$Vector, vector.x / len, vector.y / len);
};
var _jappeace$schijt_je_rijk$Vector$perpendicular = function (vector) {
	return A2(_jappeace$schijt_je_rijk$Vector$Vector, 0 - vector.y, vector.x);
};
var _jappeace$schijt_je_rijk$Vector$truncate = F2(
	function (max, vector) {
		return (_elm_lang$core$Native_Utils.cmp(
			_jappeace$schijt_je_rijk$Vector$length(vector),
			max) > 0) ? A2(
			_jappeace$schijt_je_rijk$Vector$multiply,
			_jappeace$schijt_je_rijk$Vector$normalize(vector),
			A2(_jappeace$schijt_je_rijk$Vector$Vector, max, max)) : vector;
	});

var _jappeace$schijt_je_rijk$Matrix$transform = F2(
	function (matrix, vector) {
		return A2(_jappeace$schijt_je_rijk$Vector$Vector, ((matrix.a1 * vector.x) + (matrix.b1 * vector.y)) + matrix.c1, ((matrix.a2 * vector.x) + (matrix.b2 * vector.y)) + matrix.c2);
	});
var _jappeace$schijt_je_rijk$Matrix$Matrix = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {a1: a, a2: b, a3: c, b1: d, b2: e, b3: f, c1: g, c2: h, c3: i};
	});
var _jappeace$schijt_je_rijk$Matrix$multiply = F2(
	function (x, y) {
		return A9(_jappeace$schijt_je_rijk$Matrix$Matrix, ((x.a1 * y.a1) + (x.a2 * y.b1)) + (x.a3 * y.c1), ((x.a1 * y.a2) + (x.a2 * y.b2)) + (x.a3 * y.c2), ((x.a1 * y.a3) + (x.a2 * y.b3)) + (x.a3 * y.c3), ((x.b1 * y.a1) + (x.b2 * y.b1)) + (x.b3 * y.c1), ((x.b1 * y.a2) + (x.b2 * y.b2)) + (x.b3 * y.c2), ((x.b1 * y.a3) + (x.b2 * y.b3)) + (x.b3 * y.c3), ((x.c1 * y.a1) + (x.c2 * y.b1)) + (x.c3 * y.c1), ((x.c1 * y.a2) + (x.c2 * y.b2)) + (x.c3 * y.c2), ((x.c1 * y.a3) + (x.c2 * y.b3)) + (x.c3 * y.c3));
	});
var _jappeace$schijt_je_rijk$Matrix$identity = A9(_jappeace$schijt_je_rijk$Matrix$Matrix, 1, 0, 0, 0, 1, 0, 0, 0, 1);
var _jappeace$schijt_je_rijk$Matrix$translate = F2(
	function (x, y) {
		return A9(_jappeace$schijt_je_rijk$Matrix$Matrix, 1, 0, 0, 0, 1, 0, x, y, 1);
	});
var _jappeace$schijt_je_rijk$Matrix$scale = F2(
	function (x, y) {
		return A9(_jappeace$schijt_je_rijk$Matrix$Matrix, x, 0, 0, 0, y, 0, 0, 0, 1);
	});
var _jappeace$schijt_je_rijk$Matrix$rotate = function (rad) {
	var c = _elm_lang$core$Basics$cos(rad);
	var s = _elm_lang$core$Basics$sin(rad);
	return A9(_jappeace$schijt_je_rijk$Matrix$Matrix, c, s, 0, 0 - s, c, 0, 0, 0, 1);
};
var _jappeace$schijt_je_rijk$Matrix$rotateAround = F2(
	function (heading, side) {
		return A9(_jappeace$schijt_je_rijk$Matrix$Matrix, heading.x, heading.y, 0, side.x, side.y, 0, 0, 0, 1);
	});

var _jappeace$schijt_je_rijk$Transformation$toWorldAround = F4(
	function (agent_heading, agent_side, agent_position, target_position) {
		return A2(
			_jappeace$schijt_je_rijk$Matrix$transform,
			A2(
				_jappeace$schijt_je_rijk$Matrix$multiply,
				A2(_jappeace$schijt_je_rijk$Matrix$rotateAround, agent_heading, agent_side),
				A2(_jappeace$schijt_je_rijk$Matrix$translate, agent_position.x, agent_position.y)),
			target_position);
	});
var _jappeace$schijt_je_rijk$Transformation$toWorld = F3(
	function (agent_rotation, agent_position, target_position) {
		return A2(
			_jappeace$schijt_je_rijk$Matrix$transform,
			A2(
				_jappeace$schijt_je_rijk$Matrix$multiply,
				_jappeace$schijt_je_rijk$Matrix$rotate(agent_rotation),
				A2(_jappeace$schijt_je_rijk$Matrix$translate, agent_position.x, agent_position.y)),
			target_position);
	});

var _jappeace$schijt_je_rijk$Model$calcDimension = function (amount) {
	return _elm_lang$core$Basics$ceiling(
		_elm_lang$core$Basics$sqrt(
			_elm_lang$core$Basics$toFloat(amount))) - 1;
};
var _jappeace$schijt_je_rijk$Model$cowAngle = function (velocity) {
	return _jappeace$schijt_je_rijk$Vector$angle(velocity) + _elm_lang$core$Basics$pi;
};
var _jappeace$schijt_je_rijk$Model$redoTimeFraction = 0.25;
var _jappeace$schijt_je_rijk$Model$mass = 0.6;
var _jappeace$schijt_je_rijk$Model$someVector = A2(_jappeace$schijt_je_rijk$Vector$Vector, 0.2, 0.2);
var _jappeace$schijt_je_rijk$Model$cowSize = 100;
var _jappeace$schijt_je_rijk$Model$tileSize = A2(_jappeace$schijt_je_rijk$Vector$Vector, 80, 80);
var _jappeace$schijt_je_rijk$Model$worldDimensions = function (lotCount) {
	var scale = _elm_lang$core$Basics$toFloat(
		_jappeace$schijt_je_rijk$Model$calcDimension(lotCount));
	return A2(
		_jappeace$schijt_je_rijk$Vector$multiply,
		_jappeace$schijt_je_rijk$Model$tileSize,
		A2(_jappeace$schijt_je_rijk$Vector$Vector, scale, scale));
};
var _jappeace$schijt_je_rijk$Model$tileScale = A2(_jappeace$schijt_je_rijk$Vector$Vector, 3, 3);
var _jappeace$schijt_je_rijk$Model$screenTileSize = A2(_jappeace$schijt_je_rijk$Vector$multiply, _jappeace$schijt_je_rijk$Model$tileSize, _jappeace$schijt_je_rijk$Model$tileScale);
var _jappeace$schijt_je_rijk$Model$maxspeed = 12.0;
var _jappeace$schijt_je_rijk$Model$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
										...
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return {size: a, count: b, remainingTime: c, timeRange: d, lotteryDuration: e, winningLot: f, cow: g, lastTime: h, tpf: i, rng: j, runningLottery: k, passedWinners: l, runAttempts: m, draftsLeft: n, showForm: o};
														};
													};
												};
											};
...
var _jappeace$schijt_je_rijk$Model$Cow = F4(
	function (a, b, c, d) {
		return {position: a, velocity: b, mass: c, wanderTarget: d};
	});
var _jappeace$schijt_je_rijk$Model$newModel = _jappeace$schijt_je_rijk$Model$Model(
	A2(_elm_lang$window$Window$Size, 0, 0))(0)(
	_elm_lang$core$Time$inSeconds(0))(
	{
		ctor: '_Tuple2',
		_0: _elm_lang$core$Time$inSeconds(0),
		_1: _elm_lang$core$Time$inSeconds(0)
	})(
	_elm_lang$core$Time$inSeconds(0))(_elm_lang$core$Maybe$Nothing)(
	A4(
		_jappeace$schijt_je_rijk$Model$Cow,
		A2(_jappeace$schijt_je_rijk$Vector$Vector, 20.0, 20.0),
		_jappeace$schijt_je_rijk$Model$someVector,
		_jappeace$schijt_je_rijk$Model$mass,
		_jappeace$schijt_je_rijk$Model$someVector))(0.0)(0.0)(
	A2(_jappeace$schijt_je_rijk$Vector$Vector, 0.1, 0.0))(false)(
	{ctor: '[]'})(1)(0)(true);
var _jappeace$schijt_je_rijk$Model$Lot = F3(
	function (a, b, c) {
		return {id: a, x: b, y: c};
	});
var _jappeace$schijt_je_rijk$Model$shitOnLot = F2(
	function (lotCount, cow) {
		var lotCoords = A2(
			_jappeace$schijt_je_rijk$Vector$applySingle,
			function (_p0) {
				return _elm_lang$core$Basics$toFloat(
					_elm_lang$core$Basics$floor(_p0));
			},
			A2(
				_jappeace$schijt_je_rijk$Vector$divide,
				A2(_jappeace$schijt_je_rijk$Vector$Vector, cow.position.x + (_jappeace$schijt_je_rijk$Model$tileSize.x * 0.8), (cow.position.y + _jappeace$schijt_je_rijk$Model$tileSize.y) + (_jappeace$schijt_je_rijk$Model$cowSize * 0.4)),
				_jappeace$schijt_je_rijk$Model$tileSize));
		var worldDimSize = _jappeace$schijt_je_rijk$Model$calcDimension(lotCount) + 1;
		return A3(
			_jappeace$schijt_je_rijk$Model$Lot,
			(worldDimSize * _elm_lang$core$Basics$floor(lotCoords.x)) + _elm_lang$core$Basics$floor(lotCoords.y),
			_elm_lang$core$Basics$floor(lotCoords.x),
			_elm_lang$core$Basics$floor(lotCoords.y));
	});
var _jappeace$schijt_je_rijk$Model$createLots = function (amount) {
	var scale = _jappeace$schijt_je_rijk$Model$calcDimension(amount);
	var ranges = A2(_elm_lang$core$List$range, 0, scale);
	return A2(
		_jappeace$schijt_je_rijk$Support$flatMap,
		function (row) {
			return A2(
				_elm_lang$core$List$map,
				function (col) {
					return A3(_jappeace$schijt_je_rijk$Model$Lot, ((row * (scale + 1)) + col) + 1, row, col);
				},
				ranges);
		},
		ranges);
};
var _jappeace$schijt_je_rijk$Model$StopLottery = {ctor: 'StopLottery'};
var _jappeace$schijt_je_rijk$Model$FormBegin = {ctor: 'FormBegin'};
var _jappeace$schijt_je_rijk$Model$FormTime = function (a) {
	return {ctor: 'FormTime', _0: a};
};
var _jappeace$schijt_je_rijk$Model$FormDraftCount = function (a) {
	return {ctor: 'FormDraftCount', _0: a};
};
var _jappeace$schijt_je_rijk$Model$FormLotCount = function (a) {
	return {ctor: 'FormLotCount', _0: a};
};
var _jappeace$schijt_je_rijk$Model$CowTick = function (a) {
	return {ctor: 'CowTick', _0: a};
};
var _jappeace$schijt_je_rijk$Model$SelectWinner = {ctor: 'SelectWinner'};
var _jappeace$schijt_je_rijk$Model$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _jappeace$schijt_je_rijk$Model$PlayLottery = function (a) {
	return {ctor: 'PlayLottery', _0: a};
};
var _jappeace$schijt_je_rijk$Model$StartLottery = {ctor: 'StartLottery'};
var _jappeace$schijt_je_rijk$Model$Fail = {ctor: 'Fail'};
var _jappeace$schijt_je_rijk$Model$Resize = function (a) {
	return {ctor: 'Resize', _0: a};
};

var _jappeace$schijt_je_rijk$Steering$jitter = 3;
var _jappeace$schijt_je_rijk$Steering$wanderTargetDistance = A2(_jappeace$schijt_je_rijk$Vector$Vector, 10, 0);
var _jappeace$schijt_je_rijk$Steering$wander = F3(
	function (position, velocity, newTarget) {
		var heading = _jappeace$schijt_je_rijk$Vector$normalize(velocity);
		var target = A2(_jappeace$schijt_je_rijk$Vector$plus, newTarget, _jappeace$schijt_je_rijk$Steering$wanderTargetDistance);
		return A2(
			_jappeace$schijt_je_rijk$Vector$minus,
			A3(
				_jappeace$schijt_je_rijk$Transformation$toWorld,
				_jappeace$schijt_je_rijk$Vector$angle(velocity),
				position,
				target),
			position);
	});
var _jappeace$schijt_je_rijk$Steering$wanderRadius = A2(_jappeace$schijt_je_rijk$Vector$Vector, 3, 3);
var _jappeace$schijt_je_rijk$Steering$nextWanderTarget = F4(
	function (time, currentTarget, rx, ry) {
		return A2(
			_jappeace$schijt_je_rijk$Vector$multiply,
			_jappeace$schijt_je_rijk$Steering$wanderRadius,
			_jappeace$schijt_je_rijk$Vector$normalize(
				A2(
					_jappeace$schijt_je_rijk$Vector$plus,
					A2(_jappeace$schijt_je_rijk$Vector$Vector, (rx * _jappeace$schijt_je_rijk$Steering$jitter) * time, (ry * _jappeace$schijt_je_rijk$Steering$jitter) * time),
					currentTarget)));
	});

var _jappeace$schijt_je_rijk$LotteryView$actionButton = F2(
	function (msg, action) {
		return A2(
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'backgound', _1: 'darkgrey'},
								_1: {
									ctor: '::',
...
var _jappeace$schijt_je_rijk$LotteryView$msgBox = F2(
						...
						_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'font-size', _1: '40pt'},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'font-family', _1: 'Comic Sans, Comic Sans MS'},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'color', _1: 'white'},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'background', _1: 'green'},
													_1: {
														ctor: '::',
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: {ctor: '_Tuple2', _0: 'border', _1: '3px solid darkgreen'},
																_1: {
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: 'text-align', _1: 'center'},
																	_1: {
																		ctor: '::',
																		_0: {ctor: '_Tuple2', _0: 'display', _1: visibility},
																		_1: {ctor: '[]'}
																	}
																}
															}
...
var _jappeace$schijt_je_rijk$LotteryView$renderLot = F2(
	function (withShape, lot) {
		var location = {
			ctor: '_Tuple2',
			_0: _jappeace$schijt_je_rijk$Model$tileSize.x * _elm_lang$core$Basics$toFloat(lot.x),
			_1: _jappeace$schijt_je_rijk$Model$tileSize.y * _elm_lang$core$Basics$toFloat(lot.y)
		};
		return A2(
			_evancz$elm_graphics$Collage$scale,
			3,
			A2(_evancz$elm_graphics$Collage$move, location, withShape));
	});
var _jappeace$schijt_je_rijk$LotteryView$render = function (model) {
	var cowTransform = A2(
		_evancz$elm_graphics$Transform$multiply,
		_evancz$elm_graphics$Transform$scale(1),
		A2(_evancz$elm_graphics$Transform$translation, 0 - model.cow.position.x, 0 - model.cow.position.y));
	var lots = A2(
		...
		A2(
			...
			function (lot) {
				return (_elm_lang$core$Native_Utils.cmp(lot.id, model.count) > 0) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(
					A2(
						_jappeace$schijt_je_rijk$LotteryView$renderLot,
						_evancz$elm_graphics$Collage$text(
							_evancz$elm_graphics$Text$fromString(
								_elm_lang$core$Basics$toString(lot.id))),
						lot));
			},
			_jappeace$schijt_je_rijk$Model$createLots(model.count)));
	var shits = A2(
		_evancz$elm_graphics$Collage$groupTransform,
		cowTransform,
		A2(
			...
			_jappeace$schijt_je_rijk$LotteryView$renderLot(
				A2(
					...
					0 - _jappeace$schijt_je_rijk$Model$tileSize.y,
					_evancz$elm_graphics$Collage$toForm(
						A3(
							_evancz$elm_graphics$Element$image,
							_elm_lang$core$Basics$floor(_jappeace$schijt_je_rijk$Model$tileSize.x / 2),
							_elm_lang$core$Basics$floor(_jappeace$schijt_je_rijk$Model$tileSize.y / 2),
							'img/shit.png')))),
			model.passedWinners));
	var clrEnd = A3(_elm_lang$core$Color$rgb, 231, 59, 87);
	var clrStart = A3(_elm_lang$core$Color$rgb, 5, 250, 140);
	var clrStops = {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 0.0, _1: clrStart},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 1.0, _1: clrEnd},
			_1: {ctor: '[]'}
		}
	};
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								...
								_jappeace$schijt_je_rijk$Model$cowAngle(model.cow.velocity),
								_evancz$elm_graphics$Collage$toForm(
									A3(_evancz$elm_graphics$Element$image, _jappeace$schijt_je_rijk$Model$cowSize, _jappeace$schijt_je_rijk$Model$cowSize, 'img/cow.png'))),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _jappeace$schijt_je_rijk$LotteryView$lotteryView = function (model) {
	var someButton = (_elm_lang$core$Native_Utils.cmp(model.draftsLeft, 1) < 0) ? A2(_jappeace$schijt_je_rijk$LotteryView$actionButton, 'Einde!', _jappeace$schijt_je_rijk$Model$StopLottery) : A2(_jappeace$schijt_je_rijk$LotteryView$actionButton, 'Begin trekking!', _jappeace$schijt_je_rijk$Model$StartLottery);
	var visibility = model.runningLottery ? 'none' : 'block';
	var winnertxt = _elm_lang$html$Html$text(
		A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			A2(
				...
				function (x) {
					return A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(x.id),
						' wint');
				},
				model.winningLot)));
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('lottery'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _jappeace$schijt_je_rijk$LotteryView$render(model),
			_1: {
				ctor: '::',
				_0: A2(
					_jappeace$schijt_je_rijk$LotteryView$msgBox,
					visibility,
					{
						ctor: '::',
						_0: someButton,
...
var _jappeace$schijt_je_rijk$Main$userput = F3(
	function (msg, string, value) {
		return A2(
							...
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$placeholder(string),
											_1: {
												ctor: '::',
...
var _jappeace$schijt_je_rijk$Main$view = function (model) {
	return (!model.showForm) ? _jappeace$schijt_je_rijk$LotteryView$lotteryView(model) : A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'left', _1: '35%'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'top', _1: '35%'},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'padding', _1: '10px'},
										_1: {
		...
		},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					ctor: '::',
					_0: A3(
						_jappeace$schijt_je_rijk$Main$userput,
						_jappeace$schijt_je_rijk$Model$FormLotCount,
						'Aantal loten',
					...
					_1: {
						...
						_0: A3(
							_jappeace$schijt_je_rijk$Main$userput,
							_jappeace$schijt_je_rijk$Model$FormDraftCount,
							'Aantal trekkingen',
							_elm_lang$core$Basics$toString(model.draftsLeft)),
						_1: {
							ctor: '::',
							_0: A3(
								_jappeace$schijt_je_rijk$Main$userput,
								_jappeace$schijt_je_rijk$Model$FormTime,
								'Tijd seconden',
								_elm_lang$core$Basics$toString(model.lotteryDuration)),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$tr,
										...
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_jappeace$schijt_je_rijk$Model$FormBegin),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
...
var _jappeace$schijt_je_rijk$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$window$Window$resizes(_jappeace$schijt_je_rijk$Model$Resize),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _jappeace$schijt_je_rijk$Model$Tick),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second / 20, _jappeace$schijt_je_rijk$Model$CowTick),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _jappeace$schijt_je_rijk$Main$parseInput = F3(
	function (func, model, input) {
		return A2(
			...
			A2(
				...
				_fredcy$elm_parseint$ParseInt$parseInt(input)));
	});
var _jappeace$schijt_je_rijk$Main$moveCow = A2(
	_elm_lang$core$Random$generate,
	_jappeace$schijt_je_rijk$Model$PlayLottery,
	A2(
		_elm_lang$core$Random$pair,
		A2(_elm_lang$core$Random$float, -1, 1),
		A2(_elm_lang$core$Random$float, -1, 1)));
var _jappeace$schijt_je_rijk$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Resize':
			...
			case 'StartLottery':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{remainingTime: model.lotteryDuration, winningLot: _elm_lang$core$Maybe$Nothing, runningLottery: true}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'PlayLottery':
				var _p2 = _p0._0._1;
				var _p1 = _p0._0._0;
				var tpf = A2(_jappeace$schijt_je_rijk$Vector$Vector, model.tpf * model.tpf, model.tpf * model.tpf);
				var newTarget = A4(_jappeace$schijt_je_rijk$Steering$nextWanderTarget, model.tpf, model.cow.wanderTarget, _p1, _p2);
				var force = A3(_jappeace$schijt_je_rijk$Steering$wander, model.cow.position, model.cow.velocity, newTarget);
				var velocity = A2(
					_jappeace$schijt_je_rijk$Vector$truncate,
					_jappeace$schijt_je_rijk$Model$maxspeed,
					A2(
						_jappeace$schijt_je_rijk$Vector$plus,
						A2(
							_jappeace$schijt_je_rijk$Vector$multiply,
							...
							A2(
								_jappeace$schijt_je_rijk$Vector$divide,
								force,
								A2(_jappeace$schijt_je_rijk$Vector$Vector, model.cow.mass, model.cow.mass))),
						model.cow.velocity));
				var newCowPosition = A2(
					_jappeace$schijt_je_rijk$Vector$modular,
					_jappeace$schijt_je_rijk$Model$worldDimensions(model.count),
					A2(_jappeace$schijt_je_rijk$Vector$plus, model.cow.position, velocity));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							cow: A4(_jappeace$schijt_je_rijk$Model$Cow, newCowPosition, velocity, model.cow.mass, newTarget),
							rng: A2(_jappeace$schijt_je_rijk$Vector$Vector, _p1, _p2)
						}),
					_1: (_elm_lang$core$Native_Utils.cmp(model.remainingTime, 0) > 0) ? _elm_lang$core$Platform_Cmd$none : _jappeace$schijt_je_rijk$Support$message(_jappeace$schijt_je_rijk$Model$SelectWinner)
				};
			case 'Tick':
				return {
					ctor: '_Tuple2',
			...
			case 'CowTick':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{tpf: (_p3 - model.lastTime) / 1000, lastTime: _p3}),
					_1: model.runningLottery ? _jappeace$schijt_je_rijk$Main$moveCow : _elm_lang$core$Platform_Cmd$none
				};
			case 'SelectWinner':
				var newCow = A4(
					_jappeace$schijt_je_rijk$Model$Cow,
					...
					A2(
						_jappeace$schijt_je_rijk$Vector$divide,
						model.cow.velocity,
						A2(_jappeace$schijt_je_rijk$Vector$Vector, 10, 10)),
					model.cow.mass,
					model.rng);
				var tryAgainModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						cow: newCow,
						remainingTime: (model.lotteryDuration * _jappeace$schijt_je_rijk$Model$redoTimeFraction) * _elm_lang$core$Basics$toFloat(model.runAttempts),
						runAttempts: model.runAttempts + 1
					});
				var draftsleft = model.draftsLeft - 1;
				var winner = A2(_jappeace$schijt_je_rijk$Model$shitOnLot, model.count, model.cow);
				return A2(_elm_lang$core$List$member, winner, model.passedWinners) ? {ctor: '_Tuple2', _0: tryAgainModel, _1: _elm_lang$core$Platform_Cmd$none} : ((_elm_lang$core$Native_Utils.cmp(winner.id, model.count) > 0) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						tryAgainModel,
						{
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							winningLot: _elm_lang$core$Maybe$Just(winner),
							cow: newCow,
							passedWinners: A2(
								_elm_lang$core$Basics_ops['++'],
								model.passedWinners,
			...
			case 'FormLotCount':
				return A3(
					_jappeace$schijt_je_rijk$Main$parseInput,
					F2(
						function (model, x) {
							return _elm_lang$core$Native_Utils.update(
								model,
					...
					F2(
						function (model, x) {
							return _elm_lang$core$Native_Utils.update(
								model,
								{
									lotteryDuration: _elm_lang$core$Time$inSeconds(
										_elm_lang$core$Basics$toFloat(x) * 1000.0)
								});
						}),
					model,
					_p0._0);
...
var _jappeace$schijt_je_rijk$Main$init = {
	ctor: '_Tuple2',
	_0: _jappeace$schijt_je_rijk$Model$newModel,
	_1: A2(
		_elm_lang$core$Task$perform,
		function (x) {
			return _jappeace$schijt_je_rijk$Model$Resize(x);
		},
		_elm_lang$window$Window$size)
};
var _jappeace$schijt_je_rijk$Main$main = _elm_lang$html$Html$program(
	{init: _jappeace$schijt_je_rijk$Main$init, view: _jappeace$schijt_je_rijk$Main$view, update: _jappeace$schijt_je_rijk$Main$update, subscriptions: _jappeace$schijt_je_rijk$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _jappeace$schijt_je_rijk$Main$main !== 'undefined') {
    _jappeace$schijt_je_rijk$Main$main(Elm['Main'], 'Main', undefined);
}
